...
# you may not use this file # Copyright (C) 2019 The Raphielscape Company LLC.
#
...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/ilham77mansiz/-PETERCORD-")
...
AFKREASON = None
ZALG_LIST = {}
LOAD_PLUG = {} in compliance with the License.
