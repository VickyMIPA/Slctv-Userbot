...
BIO_SUCCESS = "```Petercord, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Petercord, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Petercord, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
